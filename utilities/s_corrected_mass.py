...
for year in years:
    ...
    for i, file, tree, dir in zip(xrange(len(files)), files, trees, dirs):
        ...
        for j in xrange(entries):
            ...
            partialFlight = TVector3(cutTree.B0_ENDVERTEX_X, cutTree.B0_ENDVERTEX_Y, cutTree.B0_ENDVERTEX_Z) - TVector3(
                cutTree.B0_OWNPV_X, cutTree.B0_OWNPV_Y, cutTree.B0_OWNPV_Z)
