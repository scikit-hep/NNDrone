...
classifier = joblib.load("./Models/classifier_rapidsim.pkl")
...
scaler = joblib.load("./Models/scaler_rapidsim.pkl")
...
plt.xlim([2, len(losses)])
plt.ylim([losses[-1], losses[2]])
plt.ylabel("Loss")
plt.yscale('log')
plt.savefig("perf/approx_lossHistory_B_temp.pdf")
...
plt.ylabel("Truth")
plt.savefig("perf/approx_vs_truth_B_temp.pdf")
